...
login-already-connected = Już połączono
login-add-title = Dodaj serwis
login-add-detail = Podłącz kolejny serwis streamingowy, aby przełączać się między nimi
