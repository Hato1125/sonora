...
login-already-connected = Already connected
login-add-title = Add a service
login-add-detail = Connect another streaming service to switch between them later
