...
login-browser-detail = Sonora прочитає сесію YouTube Music з обраного браузера.
login-already-connected = Уже підключено
login-add-title = Додати сервіс
login-add-detail = Підключіть ще один стримінговий сервіс, щоб перемикатися між ними
